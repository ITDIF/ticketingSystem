...
public class RabbitService {
     ...
     * 出票
     */
    public void sendDirectMessageTicket(String orderNumber) {
    ...
    public void sendDirectMessageCandidate(String orderNumber) {
        String createTime = LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss"));
        Map<String,Object> map=new HashMap<>();
        map.put("createTime",createTime);
        map.put("orderNumber", orderNumber);
    ...
    public int waitingSuccess(String routeNumber, String departureTime){
        Map<String,Object> map=new HashMap<>();
        map.put("routeNumber", routeNumber);
        map.put("departureTime", departureTime);
        rabbitTemplate.convertAndSend("TicketSuccessExchange", "waiting_success_key", map);
        return 1;
    }
    public void cancelOrder(String order_number, String date) {
        Map<String,Object> map=new HashMap<>();
        map.put("date",date);
    ...
    public void cancelCandidateOrder(String order_number) {
        Map<String,Object> map=new HashMap<>();
    ...
    public void deadlineCandidate(String order_number, Timestamp departure_time){
